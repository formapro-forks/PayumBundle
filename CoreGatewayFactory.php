...
class CoreGatewayFactory extends BaseCoreGatewayFactory implements ContainerAwareInterface
{
    /**
    ...
    public function createConfig(array $config = array())
    {
        ...
        $rc = new \ReflectionClass(ReplyToSymfonyResponseConverter::class);
        $config['twig.paths'] = array_replace([
            'PayumSymfonyBridge' => dirname($rc->getFileName()).'/Resources/views',
        ], $config['twig.paths'] ?: []);
